 ...
 */
public class ecrit_adapter extends ArrayAdapter<String> {
    ...
    public ecrit_adapter(Context context, String[] values, String [] image) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else
        {
            ...
            imageView.setImageResource(R.drawable.ic_ecrit);
        }
